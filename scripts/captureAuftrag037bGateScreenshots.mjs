...
const SCREENSHOT_DIR = path.resolve(process.cwd(), 'docs/screenshots/auftrag-037b');
fs.mkdirSync(SCREENSHOT_DIR, { recursive: true });

export const TARGET_ROUTES = [
  { id: 'idea', path: '/company/idea', name: 'Geschäftsidee', focusedSelector: '[data-testid="idea-signal-map"]' },
  { id: 'value-proposition', path: '/company/value-proposition', name: 'Value Proposition', focusedSelector: '[data-testid="value-benefit-deck"]' },
  { id: 'history', path: '/company/history', name: 'Gründung und Entwicklung', focusedSelector: '[data-testid="history-timeline"]' },
  { id: 'location', path: '/company/location', name: 'Sitz & Räumlichkeiten', focusedSelector: '[data-testid="location-headquarters"]' },
];
...
export async function main() {
  console.log('=======================================================');
  console.log(`🚀 STARTING AUFTRAG 037B SCREENSHOT HARNESS (STAGE: ${(stage || 'N/A').toUpperCase()})`);
  console.log('=======================================================');
  ...
  try {
    ...
    const cdpPort = await findAvailablePort(9255, HOST);
    userDataDir = path.resolve(process.cwd(), `.tmp-chrome-037b-${stage}`);
    ...
    console.log('\n🎉 ALL AUFTRAG 037B SCREENSHOTS CAPTURED SUCCESSFULLY!');
  } finally {
