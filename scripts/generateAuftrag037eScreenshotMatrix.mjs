...
import { TARGET_ROUTES, VIEWPORTS } from './captureAuftrag037eGateScreenshots.mjs';
...
console.log('=======================================================');
console.log('📊 GENERATING AUFTRAG 037E SCREENSHOT MATRIX (GATE G21E)');
console.log('=======================================================');
...
const markdown = `# Screenshot-Matrix: Auftrag 037E / Gate G21E (Vertrieb & Marketing sowie Finanzen WebP-Ansichten)
...
## Zusammenfassung
- **Geprüfte Routen:** 7 (/sales/funnel, /sales/sla, /sales/channels, /sales/planning, /finance/p-and-l, /finance/balance-sheet, /finance/unit-economics)
