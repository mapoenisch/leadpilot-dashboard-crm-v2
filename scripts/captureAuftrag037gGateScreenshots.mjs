...
export const TARGET_ROUTES = [
  {
    ...
    focusedSelector: '[data-testid="overview-profile-webp"], [data-testid="company-profile-matrix"], main > div',
  },
  {
    id: 'overview-highlights',
    path: '/company/highlights',
    name: 'Jahres-Highlights 2025',
    focusedSelector: '[data-testid="overview-highlights-webp"], [data-testid="year-highlights-deck"], main > div',
  },
  {
    id: 'overview-data-basis',
    path: '/company/data-basis',
    name: 'Datenbasis & Konsistenz',
    focusedSelector: '[data-testid="overview-data-basis-webp"], [data-testid="data-basis-flow"], main > div',
  },
  {
    id: 'company-idea',
    path: '/company/idea',
    name: 'LeadPilot Geschäftsidee',
    focusedSelector: '[data-testid="company-idea-webp"], [data-testid="idea-signal-map"], main > div',
  },
  {
    id: 'company-value-proposition',
    path: '/company/value-proposition',
    name: 'Value Proposition & Positionierung',
    focusedSelector: '[data-testid="company-value-proposition-webp"], [data-testid="value-command-statement"], main > div',
  },
  {
    id: 'company-history',
    path: '/company/history',
    name: 'Gründung & Finanzierungshistorie',
    focusedSelector: '[data-testid="company-history-webp"], [data-testid="history-timeline"], main > div',
  },
  {
    id: 'product-features',
    path: '/product/features',
    name: 'Produkt & Funktionsweise',
    focusedSelector: '[data-testid="product-features-webp"], [data-testid="product-features-grid"], main > div',
  },
  {
    id: 'product-pricing',
    path: '/product/pricing',
    name: 'Preismodell',
    focusedSelector: '[data-testid="product-pricing-webp"], [data-testid="product-pricing-deck"], main > div',
  },
  {
    id: 'product-performance',
    path: '/product/performance',
    name: 'Produkt-Performance & Qualitätsmetriken GJ 2025',
    focusedSelector: '[data-testid="product-performance-webp"], [data-testid="product-performance-cockpit"], main > div',
  },
  {
    id: 'product-roadmap',
    path: '/product/roadmap',
    name: 'Release-Historie & Roadmap 2026',
    focusedSelector: '[data-testid="product-roadmap-webp"], [data-testid="product-roadmap-scene"], main > div',
  },
];
...
export async function main() {
  console.log('=======================================================');
  console.log(`🚀 STARTING AUFTRAG 037G SCREENSHOT HARNESS (STAGE: ${(stage || 'N/A').toUpperCase()})`);
  console.log('=======================================================');
  ...
  try {
    ...
    userDataDir = path.resolve(process.cwd(), `.tmp-chrome-037g-${stage}`);
    ...
    console.log('\n🎉 ALL AUFTRAG 037G SCREENSHOTS CAPTURED SUCCESSFULLY!');
  } finally {
