...
import { TARGET_ROUTES, VIEWPORTS } from './captureAuftrag037bGateScreenshots.mjs';
...
console.log('=======================================================');
console.log('📊 GENERATING AUFTRAG 037B SCREENSHOT MATRIX (GATE G21B)');
console.log('=======================================================');
...
const markdown = `# Screenshot-Matrix: Auftrag 037B / Gate G21B (Unternehmen Cyberpunk-Fintech Redesign)
...
## Zusammenfassung
- **Geprüfte Routen:** 4 (/company/idea, /company/value-proposition, /company/history, /company/location)
- **Geprüfte Viewports je Route:** 3 (1440px, 768px, 375px) = 12 Vollseiten-Paare + 4 fokussierte Paare
