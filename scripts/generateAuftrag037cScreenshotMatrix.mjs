...
import { TARGET_ROUTES, VIEWPORTS } from './captureAuftrag037cGateScreenshots.mjs';
...
console.log('=======================================================');
console.log('📊 GENERATING AUFTRAG 037C SCREENSHOT MATRIX (GATE G21C)');
console.log('=======================================================');
...
const markdown = `# Screenshot-Matrix: Auftrag 037C / Gate G21C (Übersicht & Produkt Cyberpunk-Fintech Redesign)
...
## Zusammenfassung
- **Geprüfte Routen:** 7 (/company/profile, /company/highlights, /company/data-basis, /product/features, /product/pricing, /product/performance, /product/roadmap)
