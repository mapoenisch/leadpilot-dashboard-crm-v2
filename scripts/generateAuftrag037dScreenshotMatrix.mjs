...
import { TARGET_ROUTES, VIEWPORTS } from './captureAuftrag037dGateScreenshots.mjs';
...
console.log('=======================================================');
console.log('📊 GENERATING AUFTRAG 037D SCREENSHOT MATRIX (GATE G21D)');
console.log('=======================================================');
...
const markdown = `# Screenshot-Matrix: Auftrag 037D / Gate G21D (Markt & Wettbewerb sowie Kunden & ICP WebP-Ansichten)
...
## Zusammenfassung
- **Geprüfte Routen:** 7 (/market/overview, /market/competition, /market/swot, /customers/icp, /customers/persona, /customers/segments, /customers/top-customers)
- **Geprüfte Viewports je Route:** 3 (1440px, 768px, 375px) = 21 Vollseiten-Paare + 7 fokussierte Paare
