...
export const TARGET_ROUTES = [
  { id: 'organisation-headcount', path: '/organisation/headcount', name: 'Headcount-Entwicklung', focusedSelector: '[data-testid="organisation-headcount-webp"], .chart-frame, main > div' },
  { id: 'organisation-hr', path: '/organisation/hr', name: 'HR-Kennzahlen', focusedSelector: '[data-testid="organisation-hr-webp"], main > div > div:nth-child(2), main > div' },
  { id: 'organisation-team', path: '/organisation/team', name: 'Teamstruktur & Engpässe', focusedSelector: '[data-testid="organisation-team-webp"], .chart-frame, main > div' },
  { id: 'strategy-okrs', path: '/strategy/okrs', name: 'Ziele & OKRs', focusedSelector: '[data-testid="strategy-okrs-webp"], .chart-frame, main > div' },
  { id: 'strategy-bsc', path: '/strategy/balanced-scorecard', name: 'Balanced Scorecard', focusedSelector: '[data-testid="strategy-bsc-webp"], .fachbereiche-v2-grid-2, main > div' },
  { id: 'strategy-growth', path: '/strategy/growth-drivers', name: 'Wachstumstreiber', focusedSelector: '[data-testid="strategy-growth-webp"], .chart-frame, main > div' },
  { id: 'legal-articles', path: '/legal/articles', name: 'Satzung LeadPilot GmbH', focusedSelector: '[data-testid="legal-articles-webp"], .fachbereiche-v2-desktop-table, main > div' },
  { id: 'legal-shareholders', path: '/legal/shareholders', name: 'Gesellschafterliste', focusedSelector: '[data-testid="legal-shareholders-webp"], .fachbereiche-v2-desktop-table, main > div' },
  { id: 'legal-register', path: '/legal/commercial-register', name: 'Handelsregisterdaten', focusedSelector: '[data-testid="legal-register-webp"], .fachbereiche-v2-desktop-table, main > div' },
];
...
export async function main() {
  console.log('=======================================================');
  console.log(`🚀 STARTING AUFTRAG 037F SCREENSHOT HARNESS (STAGE: ${(stage || 'N/A').toUpperCase()})`);
  console.log('=======================================================');
  ...
  try {
    ...
    const previewPort = await findAvailablePort(4250, HOST);
    ...
    const cdpPort = await findAvailablePort(9290, HOST);
    userDataDir = path.resolve(process.cwd(), `.tmp-chrome-037f-${stage}`);
    ...
    console.log('\n🎉 ALL AUFTRAG 037F SCREENSHOTS CAPTURED SUCCESSFULLY!');
  } finally {
