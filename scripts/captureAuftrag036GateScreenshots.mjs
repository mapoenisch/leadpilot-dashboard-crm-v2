...
export const TARGET_PAGE = {
  id: 'dashboard',
  path: '/dashboard',
  name: 'Executive Dashboard (Ebene A & C Observability)',
};
...
async function main() {
  console.log('=======================================================');
  console.log(`🚀 STARTING AUFTRAG 036 SCREENSHOT HARNESS (STAGE: ${stage.toUpperCase()})`);
  console.log('=======================================================');
  ...
  try {
    ...
    userDataDir = path.resolve(process.cwd(), `.tmp-chrome-036-${stage}`);
