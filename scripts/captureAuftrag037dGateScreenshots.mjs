...
const SCREENSHOT_DIR = path.resolve(process.cwd(), 'docs/screenshots/auftrag-037d');
fs.mkdirSync(SCREENSHOT_DIR, { recursive: true });

export const TARGET_ROUTES = [
  { id: 'market-overview', path: '/market/overview', name: 'Marktlage DACH', focusedSelector: '[data-testid="market-dach-webp"], .fachbereiche-v2-desktop-table, main > div' },
  { id: 'market-competition', path: '/market/competition', name: 'Wettbewerbslandschaft', focusedSelector: '[data-testid="market-competition-webp"], .fachbereiche-v2-desktop-table, main > div' },
  { id: 'market-swot', path: '/market/swot', name: 'SWOT-Analyse', focusedSelector: '[data-testid="market-swot-webp"], .fachbereiche-v2-grid-2, main > div' },
  { id: 'customers-icp', path: '/customers/icp', name: 'Ideal Customer Profile', focusedSelector: '[data-testid="customers-icp-webp"], .fachbereiche-v2-grid-2, main > div' },
  { id: 'customers-persona', path: '/customers/persona', name: 'Buyer Persona Volker', focusedSelector: '[data-testid="customers-persona-webp"], .fachbereiche-v2-grid-2, main > div' },
  { id: 'customers-segments', path: '/customers/segments', name: 'Kundensegmente', focusedSelector: '[data-testid="customers-segments-webp"], .fachbereiche-v2-desktop-table, main > div' },
  { id: 'customers-top10', path: '/customers/top-customers', name: 'Top-10 Kunden', focusedSelector: '[data-testid="customers-top10-webp"], .fachbereiche-v2-desktop-table, main > div' },
];
...
export async function main() {
  console.log('=======================================================');
  console.log(`🚀 STARTING AUFTRAG 037D SCREENSHOT HARNESS (STAGE: ${(stage || 'N/A').toUpperCase()})`);
  console.log('=======================================================');
  ...
  try {
    ...
    const previewPort = await findAvailablePort(4230, HOST);
    ...
    const cdpPort = await findAvailablePort(9270, HOST);
    userDataDir = path.resolve(process.cwd(), `.tmp-chrome-037d-${stage}`);
    ...
    console.log('\n🎉 ALL AUFTRAG 037D SCREENSHOTS CAPTURED SUCCESSFULLY!');
  } finally {
