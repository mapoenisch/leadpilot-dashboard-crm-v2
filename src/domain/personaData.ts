export const BUYER_PERSONA_VOLKER = {
  ...
  goals: [
    ...
    'Vertrieb digitalisieren ohne langes IT-Einführungsprojekt',
  ],
  painPoints: [
    'Verlorene Leads: bis zu 70 % der Marketing-Leads werden nach Erstkontakt nicht konsequent nachgefasst',
    'Zeitmangel & Tabellen-Chaos in Excel',
    'Sorge vor langwierigen und teuren Software-Einführungen',
  ],
  channels: [
