export const IDEE = {
  title: 'Die LeadPilot Geschäftsidee',
  subtitle: 'Smarte B2B-Lead-Management Software für den deutschen Mittelstand.',
  paragraphs: [
    'Tausende mittelständische Unternehmen im DACH-Raum investieren erhebliche Budgets in Messen, Online-Marketing und LinkedIn, um wertvolle B2B-Leads zu generieren. Doch im hektischen Tagesgeschäft werden Leads nach Erstkontakt nicht konsequent nachgefasst: Sie verbleiben in Excel-Listen, E-Mail-Postfächern oder Notizblöcken.',
    'LeadPilot schließt die Lücke zwischen überkomplexen Enterprise-CRMs (wie Salesforce oder HubSpot), die monatelange Einführungen und hohe Budgets erfordern, und unübersichtlichen Tabellen. LeadPilot bietet B2B-KMU ein sofort einsatzbereites Lead-Management-Cockpit unter dem Claim „Kein Lead bleibt zurück.".',
  ],
  usps: [
    'Einrichtung in unter 30 Minuten ohne eigene IT-Abteilung',
    'Natives KI-Lead-Scoring nach ICP-Kriterien',
    'Automatisierte Nurturing-Sequenzen auf Autopilot',
    '100 % DSGVO-konform mit Serverstandort Deutschland (Frankfurt/Main)',
  ],
};
...
export const STANDORT = {
  ...
  address: 'Augustusplatz 9, 04109 Leipzig, Sachsen',
  details: [
