...
export const BSC = {
  ...
  perspectives: [
    ...
    { name: 'Kunden', kpis: 'NPS: 34, Account-Churn: 2,8 %, Mktg-CAC: 862 €, Fully-Loaded CAC: 4.447 €' },
    { name: 'Interne Prozesse', kpis: 'Trial-to-Paid: 18 %, Time-to-Value: 11 Tage, Uptime: 99,7 %' },
    { name: 'Lernen & Entwicklung', kpis: 'Headcount: 10 FTE (Ziel: 12 FTE), Fluktuation: 22 %, 60 % Remote' },
  ],
};
...
export const MASSNAHMEN = {
  ...
  items: [
    { name: 'Guided Trial Onboarding Flow (v2.0)', prio: 'P1 (Kritisch)', owner: 'Tobias Heine (CTO)' },
    ...
    { name: 'ICP-Qualifizierung in Inbound-Prozessen', prio: 'P1 (Hoch)', owner: 'Sales & Marketing' },
  ],
};
...
export const CHART_OKR = {
  type: 'bar' as const,
  labels: ['ARR (T€/10)', 'Kunden', 'Trial-to-Paid (%)', 'Churn (%)', 'KI-Scoring (%)', 'Headcount', 'LTV:CAC (x10)', 'Burn (T€/M)'],
  datasets: [
...
export const CHART_TREIBER = {
  type: 'bar' as const,
  labels: ['Trial-to-Paid 18→26%', 'Churn 2,8→1,8%', 'Partnerprogramm', 'ICP-Schärfung (ARPA)', 'Upsell Starter→Growth'],
  datasets: [{
...
export const RISIKO = {
  ...
  rows: [
    ['Trial-Conversion stagniert bei 18 %', 'Mittel', 'Hoch', 'Einführung des Guided Onboarding Wizards (v2.0) in Q1/2026'],
    ['Runway von 14 Monaten schrumpft durch Burn Rate', 'Mittel', 'Hoch', 'Senkung der Burn Rate auf < 23.000 € / Monat'],
    ['Single Point of Failure beim CTO für KI-Engine', 'Hoch', 'Kritisch', 'Dokumentation & Recruiting zweier Senior Frontend/Fullstack Devs'],
    ['Account-Churn im Kleinstkundensegment bleibt hoch', 'Mittel', 'Mittel', 'Strikterer ICP-Filter im Vertrieb (kein Negative-Fit)'],
  ],
};
