-- 067F / G49 (Nacharbeit P1): Finaler Run-State als Spalte.
-- Die Audit-Ansicht zeigt Tick-Anzahl, Invarianten-Status und Rejected-
-- Transitions aus `finalState` — ohne Spalte fielen sie nach Reload auf
-- Defaultwerte (0 / „100% VALIDE") zurück. `final_state` schließt die Lücke;
-- die Hydrierung mappt sie zurück auf `SimulationRun.finalState`.
